    ...
    <div class="app-layout">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="https://github.com/SebasHuaypar/worldcup-predictive-engine-api" target="_blank" class="sidebar-nav-item">
                ...
                <a href="https://www.linkedin.com/in/sebashuaypar" target="_blank" class="sidebar-nav-item">
